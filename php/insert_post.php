    ...
    <body class="bg-dark">
        ...
        <div class="container">
            <nav class="nav d-flex">
                ...
                <div class="col-1 p-2">
                    <a class="nav-link px-2" title = "Elimina un articulo"  style = "border-right:1px solid white ; height:100% ;  width:100%; " href=""><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="red" class="bi bi-trash3" viewBox="0 0 16 16">
                            ...
                            <div class="card-header"><h5>Adjuntos</h5></div>
                                <div class="card-body card-text">
                                    <div class="input-group w-50">
                                        ...
                                        <input type="file" class="form-control" name = "adjunto" placeholder="Input group example" aria-label="Input group example" aria-describedby="basic-addon1" required>
                                    </div>
                                </div>
                                ...
                                <div class="card-body card-text">
                                    <div class="input-group w-50">
                                        ...
                                        <input type="file" class="form-control" name="file" placeholder="portada" aria-label="Input group example" aria-describedby="basic-addon1" required>
                                    </div>
                                </div>
                                ...
                                <div class="card-body card-text">
                                    <div class="input-group w-50">
                                        ...
                                        <input type="text" class="form-control" name="urlVideo" placeholder="url video" aria-label="Input group example" aria-describedby="basic-addon1" required>
                                    </div>
                                </div>
