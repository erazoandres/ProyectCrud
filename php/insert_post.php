    ...
    <body class="bg-dark">
        ...
        <div class="container">
            <nav class="nav d-flex">
                ...
                <div class="col-1 p-2">
                    <a class="nav-link px-2 " title = "Edita un articulo" style = "border-right:1px solid white ; height:100% ; width:100% " href="search.php?userPostSearch=<?php echo $_SESSION["name"] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-credit-card-2-front" viewBox="0 0 16 16">
