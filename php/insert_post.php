                            ...
                            <div class="card-header"><h5>Adjuntos</h5></div>
                                <div class="card-body card-text">
                                    <div class="input-group w-50">
                                        ...
                                        <input type="file" class="form-control" name = "adjunto" placeholder="Input group example" aria-label="Input group example" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                ...
                                <div class="card-body card-text">
                                    <div class="input-group w-50">
                                        ...
                                        <input type="text" class="form-control" name="videoUrl" placeholder="Input group example" aria-label="Input group example" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                ...
                                <div class="card-body card-text">
                                    <div class="input-group w-50">
                                        ...
                                        <input type="file" class="form-control" name="file" placeholder="Input group example" aria-label="Input group example" aria-describedby="basic-addon1">
                                    </div>
                                </div>
