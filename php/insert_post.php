...
<html>
    ...
    <div class="container p-4">
        <div class="row">
            <div class="col-8 bg-primary p-0" style="height:250px">
                <form action="" class="mx-0 text-center">
                    ...
                    <div class="d-grid"><button type="submit" class=" btn btn-outline-primary p-2 mt-2">Postear</button></div>
                </form>
            </div>
            <div class="col-4 bg-success d-none d-md-block " style="height:100vh">
